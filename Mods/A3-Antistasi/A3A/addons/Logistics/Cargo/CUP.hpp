class CUP_Weapons_CUP_Weapons_StaticWeapons_DShKM_CUP_DShKM_mg_p3d : TRIPLES(ADDON,Cargo,Base)
{
    offset[] = {0.25,-1,1.62};
    rotation[] = {0,0,0};
    size = 4;
