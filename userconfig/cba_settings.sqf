...
force AAA_VAR_IND_ARMOR_COEF = 8;
force AAA_VAR_MOD_ENABLED = true;
force AAA_VAR_OPFOR_ARMOR_COEF = 8;
force AAA_VAR_PLAYERS_ENABLED = true;
force AAA_VAR_PLAYER_ARMOR_COEF = 8;
...
force LootingEnhanced_DisassembleWeapon = true;
...
force ace_common_epilepsyFriendlyMode = true;
...
force ace_ui_hideDefaultActionIcon = true;
...
force cba_events_repetitionMode = 2;
...
force ivcs_inital_silence_timeout = 1;
force ivcs_output_group_chat = true;
force ivcs_target_confirm_ui = false;
