...
ExecVm "sounds\musicHandler_Vietnam\addEventHandlerForMusic.sqf";
...
{//Main Loop
	if(isMusicActive == 1) then
	{
		...
		[battleIntensityLowerer] ExecVm "sounds\musicHandler_Vietnam\battleIntensityChange.sqf";
		...
		execVM "sounds\musicHandler_Vietnam\musicPlayer1.sqf";
