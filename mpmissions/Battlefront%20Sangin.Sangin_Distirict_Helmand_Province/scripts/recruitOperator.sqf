...
[
	...
	"Recruit Operator",										// Title of the action
	...
	{
    private _unit = (group _caller) createUnit ["B_Soldier_F", getPosATL _caller, [], 2, "NONE"];
    ...
    // Add weapons
    _unit addWeapon "hlc_rifle_RU5562";
    ...
    for "_i" from 1 to 10 do {_unit addItemToVest "hlc_30rnd_556x45_M_PMAG";};
