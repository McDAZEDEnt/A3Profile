fnc_autoLoad = compile preprocessFileLineNumbers "Functions\fnc\fnc_autoLoad.sqf";publicVariable "fnc_autoLoad";
...
fnc_fleeSurrender = compile preprocessFileLineNumbers "Functions\fnc\fnc_fleeSurrender.sqf";publicVariable "fnc_fleeSurrender";
