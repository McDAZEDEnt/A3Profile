...
_units,
getPos _module,
(_module getVariable"dmpMissionPreventArrivalText"),
(_module getVariable"dmpMissionPreventArrivalDistance"),
(_module getVariable"dmpMissionPreventArrivalScript"),
(_module getVariable"dmpGoCodeIn"),
(_module getVariable"dmpGoCodeOut"),
(_module getVariable"dmpOptional")
]execVM"DMP\Scripts\Missions\zzModulePreventArrival.sqf";
};
true