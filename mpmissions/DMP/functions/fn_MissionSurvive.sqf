...
[
getPos _module,
(_module getVariable"dmpMissionSurviveText"),
(_module getVariable"dmpMissionSurviveMinutes"),
(_module getVariable"dmpMissionSurviveScript"),
(_module getVariable"dmpGoCodeIn"),
(_module getVariable"dmpGoCodeOut"),
(_module getVariable"dmpOptional")
]execVM"DMP\Scripts\Missions\zzModuleSurvive.sqf";
};
true