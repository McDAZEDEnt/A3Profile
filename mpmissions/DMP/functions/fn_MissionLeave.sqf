...
[
getPos _module,
(_module getVariable"dmpMissionLeaveText"),
(_module getVariable"dmpMissionLeaveDistance"),
(_module getVariable"dmpMissionLeaveScript"),
(_module getVariable"dmpGoCodeIn"),
(_module getVariable"dmpGoCodeOut"),
(_module getVariable"dmpOptional")
]execVM"DMP\Scripts\Missions\zzModuleLeave.sqf";
};
true