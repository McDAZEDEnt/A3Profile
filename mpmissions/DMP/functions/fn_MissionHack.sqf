...
_units,
getPos _module,
(_module getVariable"dmpMissionHackText"),
(_module getVariable"dmpMissionHackTime"),
(_module getVariable"dmpMissionHackScript"),
(_module getVariable"dmpGoCodeIn"),
(_module getVariable"dmpGoCodeOut"),
(_module getVariable"dmpOptional")
]execVM"DMP\Scripts\Missions\zzModuleHack.sqf";
};
true