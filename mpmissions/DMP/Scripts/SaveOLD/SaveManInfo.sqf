...
private["_man","_vehicles","_characterInfo","_name","_type","_side","_rank","_face","_speaker","_pitch","_pos","_dir","_uPos","_dam","_loadout","_allVars","_vars","_index","_vRole"];
_man=_this select 0;
...
//_allVars=allVariables _man;_vars=[];{_vars pushBack[(_x,_man getVariable _x)]}forEach _allVars;
